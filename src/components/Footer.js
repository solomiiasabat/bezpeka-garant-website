        ...
        <div className="row">
          ...
          <div className="col mt-4 pagecontent">
            <ul className="footer-pagecontent-list">
              ...
              <li className="footer-content">Інструкція з використання</li>
              <li className="footer-content">Контакти</li>
            </ul>
          </div>

          <div className="col mt-4 contacts">
          ...
          <div className="col mb-2 location">
            <iframe
